...
export default function SocialLogin() {
    ...
    return (
        <>
            <GoogleLogin
                clientId={'1002547614037-1v1oe3v7oh13dfpv3hh7b6culcf46e2s.apps.googleusercontent.com'}
                render={renderProps => (
                    <img src={GoogleImg} onClick={renderProps.onClick} disabled={renderProps.disabled}  style={{marginRight: 10}}/>
                )} 
            ...
            <KakaoLogin 
                ...
                render={renderProps => (
                    <img src={KakaoImg} onClick={renderProps.onClick} disabled={renderProps.disabled} style={{marginRight: 10}}/>
                )} 
            ...
            <NaverLogin 
                ...
                render={renderProps => (
                    <img src={NaverImg} onClick={renderProps.onClick} disabled={renderProps.disabled} style={{marginRight: 10}}/>
                )} 
